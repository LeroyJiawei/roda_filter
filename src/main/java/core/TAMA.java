...
public class TAMA {
    ...
    private static final String mtFile = "src/main/resources/mt-tama.txt";

    public static void main(String[] args) {

        Properties properties = new Properties();
        try {
            InputStream inputStream = new FileInputStream(new File("src/main/resources/common.properties"));
        ...
        // influxdb connection
        InfluxdbUtil influx = InfluxdbUtil.setUp("","matchTime");
                        ...
                        for(List e:bucketlist[stock_id][attribute_id][j][t].bucket){
                            ...
                            if (sets[stock_id][e.Id].matched_num == sets[stock_id][e.Id].attribute_num) {
                                ...
                                Thread thread = new Thread(() -> {
                                    // match time
//                                    this.v.EventMatchTime = (System.nanoTime() - this.v.EventArriveTime);
        ...
        event.foreach((k, v) -> {
            ...
            v.EventArriveTime = System.nanoTime();
